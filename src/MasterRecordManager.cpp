...
public:
    bool addAccount(string name,string phone,string email);
...
bool MasterRecordManager::addAccount(string name,string phone,string email){
    ...
    try{
        ...
        details_line = details_line + new_account_no + "|" + name + "|" + phone + "|" + email;
